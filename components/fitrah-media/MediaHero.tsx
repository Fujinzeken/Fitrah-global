...
// PRD §9 Page 6 — Fitrah Media hero. Headline + subheadline verbatim. Lower
// strip lists the seven Editorial Categories (PRD §9 Page 6, verbatim) as a
// preview of the page's editorial scope.
      ...
      <div className="mx-auto max-w-[1320px] px-10 max-md:px-[22px]">
        ...
        <Reveal delay={120}>
          <h1 className="mt-14 max-w-[16ch] font-serif font-normal text-green-700 leading-[1.02] tracking-[-0.026em] text-[clamp(38px,5.6vw,88px)] max-md:mt-10">
            The media and intelligence layer for the{" "}
        ...
        <Reveal delay={260}>
          <p className="mt-12 max-w-[60ch] text-[18px] leading-[1.6] text-ink tracking-[-0.005em] max-md:mt-9">
            Fitrah Media tells the stories, tracks the trends, and builds the
            narratives shaping Muslim technology, commerce, culture, AI, and
            community.
          </p>
        </Reveal>
        ...
        {/* Editorial categories strip — seven PRD categories as a chip cloud. */}
