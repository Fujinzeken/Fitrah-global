...
// PRD §9 Page 11 — Careers hero. Headline + subheadline verbatim. Lower strip
// lists the nine Teams (PRD §9 Page 11, verbatim) as a preview of the teams
// section below.
  ...
  return (
    <section className="relative overflow-hidden pt-[120px] pb-[80px] max-md:pt-22 max-md:pb-12">
      <div className="mx-auto max-w-[1320px] px-10 max-md:px-[22px]">
        ...
        <Reveal delay={120}>
          <h1 className="mt-14 max-w-[14ch] font-serif font-normal text-green-700 leading-[1.0] tracking-[-0.028em] text-[clamp(44px,7vw,108px)] max-md:mt-10">
            Build technology with{" "}
            <em className="italic font-light text-green-500">purpose.</em>
          </h1>
        </Reveal>

        <Reveal delay={260}>
          <p className="mt-12 max-w-[58ch] text-[18px] leading-[1.6] text-ink tracking-[-0.005em] max-md:mt-9">
            Join Fitrah Global to build products that serve people, strengthen
            communities, and shape the future of the Muslim digital economy.
          </p>
        </Reveal>
        ...
        {/* Teams strip — nine PRD teams as a chip cloud. */}
